...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_TQ3_0   = 41, // TurboQuant 3-bit (PolarQuant with optimal Lloyd-Max codebook)
        GGML_TYPE_TQ4_0   = 42, // TurboQuant 4-bit (PolarQuant with optimal Lloyd-Max codebook)
        GGML_TYPE_COUNT   = 43,
    };
